                  ...
                  <div className="mt-3 sm:mt-4 p-3 sm:p-4 rounded-lg" style={{ background: 'rgba(46,125,156,0.08)', border: '1px solid rgba(46,125,156,0.2)' }}>
                    ...
                    <div className="mt-2 text-center">
                      <a
                        ...
                        title="Get directions to Avyakta office on Google Maps"
                      >
                        Get Directions
                      </a>
                    </div>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6" style={{ borderTop: '1px solid #E2E8F0' }}>
                  ...
                  <div className="flex justify-center space-x-3 sm:space-x-4">
                    {[
                      ...
                      <a key={i} href="#" className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 text-white rounded-full transition-all duration-300 transform hover:scale-110 shadow-md" style={{ background: social.bg }} title={`Follow Avyakta on ${i === 0 ? 'Facebook' : i === 1 ? 'X (Twitter)' : 'LinkedIn'}`}>
