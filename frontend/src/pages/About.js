...
export const PrivacyPolicy = () => (
  <div className="prose max-w-none text-gray-800">
    <div className="flex items-center gap-3 mb-4">
      ...
      <h2 className="!my-0 !text-2xl font-bold text-blue-800">Privacy Policy</h2>
    </div>
    <p className="italic text-lg text-blue-700 font-medium mb-2">Because Every Voice Matters, Every Soul Deserves Dignity</p>
    <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded mb-6 shadow-sm">
      <p className="mb-0">At <span className="font-semibold text-blue-900">Avyakta</span>, we understand — some things are too painful to speak aloud.<br/>
    ...
    <div className="flex items-center gap-2 mt-8 mb-2">
      ...
      <h3 className="!my-0 !text-xl font-semibold text-pink-700">Your Privacy Is Sacred</h3>
    </div>
    <ul className="list-disc pl-6 text-base mb-4">
      <li>When you report anonymously, <span className="font-semibold text-pink-700">no name, location, or contact</span> is stored unless you choose.</li>
      <li>Any personal detail shared is held in <span className="font-semibold text-pink-700">strict confidence</span>, never revealed to anyone without your will.</li>
      <li>We do <span className="font-semibold text-pink-700">not track, sell, or analyze</span> your identity. We're here to listen, not exploit.</li>
    </ul>
    <div className="flex items-center gap-2 mt-8 mb-2">
      <span className="text-2xl">🛡</span>
      <h3 className="!my-0 !text-xl font-semibold text-green-700">Safety with Sensitivity</h3>
    </div>
    <ul className="list-disc pl-6 text-base mb-4">
      <li>All your data is <span className="font-semibold text-green-700">encrypted and protected</span> with top-level security.</li>
      <li>Whether you're a grieving stranger, a concerned citizen, or a silent witness — <span className="font-semibold text-green-700">your safety is non-negotiable</span>.</li>
      <li>You can reach out to us anytime to <span className="font-semibold text-green-700">edit, delete, or retract</span> your report. We respect your decision at every step.</li>
    </ul>
    <div className="flex items-center gap-2 mt-8 mb-2">
      <span className="text-2xl">🌱</span>
      <h3 className="!my-0 !text-xl font-semibold text-emerald-700">Why This Matters</h3>
    </div>
    <div className="bg-emerald-50 border-l-4 border-emerald-400 p-4 rounded mb-6 shadow-sm">
      <p className="mb-0">Behind every report is a life once lived.<br/>
    ...
    <blockquote className="border-l-4 border-blue-400 pl-4 italic text-blue-800 bg-blue-50 rounded py-2 mb-6">
      "You are not alone in this act of kindness. And they are not forgotten, because you cared enough to remember."
    </blockquote>
    <div className="flex items-center gap-2 mt-8 mb-2">
      <span className="text-2xl">✅</span>
      <span className="font-semibold text-blue-900">By using Avyakta, you agree to this promise — that your privacy is as important as your purpose.</span>
    </div>
  </div>
);
